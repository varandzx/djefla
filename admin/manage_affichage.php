<?php   
 ...
 <table id="tbl" border="1" cellspacing="0" cellpadding="0">
     <br>  
 <a href="add_affichage.php" class="btn-prime">ADD AFFICHAGE</a> <br>
                ...
                while ($result = mysqli_fetch_assoc($run)) {  
                     echo "  
                          <tr class='data'>  
                               ...
                               <td>".$result['anne']."</td>  
                               <td><a href='deleteaff.php?id=".$result['id']."' id='btn'>Delete</a></td>  
                          </tr>  
                     ";  
                }  
           }  
