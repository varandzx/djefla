<?php include('db.php') ;
$r = mysqli_query($conn, "select * from cours");
...
<body>
    <header>
        <a href="index.php" class="logo">  <link rel="shortcut icon" type="image/x-icon" href="images/logo.ico" />  informatique</a>
        <!-- <a href="logout.php" class="login"> Logout </a>
        <a href="#" class="login">Cours</a> -->
        <nav class="nav">
    ...
    <section class="main"> 
        <div>
            <h2 class="h2">here u can download cours  <br> <span>COURS</span> </h2>
